...
const Answers = () => {
  // Твій оновлений список з 3-х питань
  const qaList = [
    {
      id: 1,
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-[1000px] relative z-10 px-12 md:px-20">
        <Swiper
          modules={[Navigation]}
          navigation={true}
          spaceBetween={50}
        ...
        >
          {qaList.map((item) => (
            <SwiperSlide key={item.id}>
              <div className="w-full max-w-[700px] mx-auto bg-[#0a0a0a]/90 backdrop-blur-md rounded-[2rem] border-2 border-cyber-red/80 shadow-[0_0_40px_rgba(255,0,60,0.4)] p-8 md:p-12 flex flex-col items-center justify-start min-h-[350px] md:min-h-[400px]">
                {/* Питання (Червоне неонове) */}
                <h3
                  className="w-full font-mono font-bold text-xl md:text-3xl text-center mb-10 text-white leading-snug"
                  style={{
                    textShadow:
                ...
                {/* Відповідь (Біла, по правому краю) */}
                <p
