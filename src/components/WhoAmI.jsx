...
const WhoAmI = () => {
  ...
  return (
    // ФІКС: Огорнули все у порожній фрагмент <>, щоб винести пасхалку за межі секції
    <>
      <section
        id="whoami"
            ...
            >
              ...
              {step >= 5 && (
                ...
                >
                  ...
                  <p>
                    <span className="text-cyan-400">NODE:</span> Lviv
                    Polytechnic (PZ-12)
                  </p>
                  <p>
      ...
      {/* ФІКС: ПАСХАЛКА ВИНЕСЕНА СЮДИ, ПОВЕРХ УСІЄЇ СЕКЦІЇ ТА НАВБАРУ */}
      <AnimatePresence>
        {showEasterEgg && (
          <motion.div
